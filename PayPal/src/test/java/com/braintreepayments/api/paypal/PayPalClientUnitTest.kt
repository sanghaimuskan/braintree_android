...
class PayPalClientUnitTest {
    ...
    @Test
    fun createPaymentAuthRequest_setsMerchantPassedUserAction_toContinue_whenUserActionIsDefault() {
    ...
    @Test
    fun createPaymentAuthRequest_setsMerchantPassedUserAction_toPay_whenUserActionIsCommit() {
        val payPalCheckoutRequest = PayPalCheckoutRequest("1.00", true).apply {
    ...
    @Test
    fun createPaymentAuthRequest_setsMerchantPassedUserAction_toNone_whenUserActionIsNull() {
        val payPalCheckoutRequest = PayPalCheckoutRequest("1.00", true).apply {
            userAction = null
        }
